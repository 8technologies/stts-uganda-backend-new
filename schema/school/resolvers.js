    ...
    addSchool: async (parent, args, context) => {
      try {
        ...
        const data = {
          ...
          digital_tool_usage_frequency: pedagogicalUsage.digitalToolUsageFrequency,
          ...
          aligned_with_national_strategy: governance.alignedWithNationalStrategy,
          ...
          students_using_digital_content: studentEngagement.studentsUsingDigitalContent,
          ...
          partner_organizations: JSON.stringify(communityEngagement.partnerOrganizations),
          ngo_support: JSON.stringify(communityEngagement.ngoSupport),
          community_contributions: JSON.stringify(communityEngagement.communityContributions),
          ...
          security_infrastructure: JSON.stringify(schoolFacilities.securityInfrastructure),
